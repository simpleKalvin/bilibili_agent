...
def create_monitor_page(page: ft.Page):
    ...
    monitor_row.set_page_visible = set_page_visible
    ...
    return ft.Container(
        content=ft.Column(
            [
                ...
                ft.Container(height=20),
                ft.Text("设置页面开发中...", size=14, color=ft.Colors.GREY_500),
            ],
            alignment=ft.MainAxisAlignment.START,
            horizontal_alignment=ft.CrossAxisAlignment.START,
        ),
...
def show_main_ui(page: ft.Page):
    ...
    def on_nav_change(e):
        ...
        if hasattr(monitor_page, 'set_page_visible'):
            monitor_page.set_page_visible(selected_index == 0)
